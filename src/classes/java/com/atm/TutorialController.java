...
public class TutorialController
{
    ...
    public void initialize(Controller controller)
    {
        ...
        BindHover(this.continueButton);
        BindPressedContinue(this.continueButton);
        BindPressedReturn(this.returnButton);
    }
    ...
    private void BindPressedContinue(Button button)
    {
    ...
    private void BindPressedReturn(Button button)
    {
        //TODO: Add ripple effect
        button.setOnMousePressed(event -> {
            this.controller.process("Return-Tutorial");
        });
    }
